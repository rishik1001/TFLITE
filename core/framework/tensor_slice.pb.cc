...
const ::_pbi::DescriptorTable descriptor_table_tensorflow_2fcore_2fframework_2ftensor_5fslice_2eproto = {
    false, false, 335, descriptor_table_protodef_tensorflow_2fcore_2fframework_2ftensor_5fslice_2eproto,
...
TensorSliceProto_Extent::TensorSliceProto_Extent(const TensorSliceProto_Extent& from)
  ...
  TensorSliceProto_Extent* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void TensorSliceProto_Extent::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
...
TensorSliceProto::TensorSliceProto(const TensorSliceProto& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  TensorSliceProto* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.extent_){from._impl_.extent_}
    , /*decltype(_impl_._cached_size_)*/{}};
...
inline void TensorSliceProto::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.extent_.~RepeatedPtrField();
}
...
// @@protoc_insertion_point(message_byte_size_start:tensorflow.TensorSliceProto)
  ...
  for (const auto& msg : this->_impl_.extent_) {
    total_size +=
...
void TensorSliceProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
