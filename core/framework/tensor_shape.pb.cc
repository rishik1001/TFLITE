...
const uint32_t TableStruct_tensorflow_2fcore_2fframework_2ftensor_5fshape_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::tensorflow::TensorShapeProto_Dim, _impl_.size_),
  PROTOBUF_FIELD_OFFSET(::tensorflow::TensorShapeProto_Dim, _impl_.name_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::tensorflow::TensorShapeProto, _impl_.dim_),
  PROTOBUF_FIELD_OFFSET(::tensorflow::TensorShapeProto, _impl_.unknown_rank_),
};
...
const ::_pbi::DescriptorTable descriptor_table_tensorflow_2fcore_2fframework_2ftensor_5fshape_2eproto = {
    false, false, 328, descriptor_table_protodef_tensorflow_2fcore_2fframework_2ftensor_5fshape_2eproto,
